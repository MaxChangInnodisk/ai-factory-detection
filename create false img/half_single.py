...
CONV_OUT_PATH="/home/nvidia/Desktop/findfinger/NG/tar_defect (flase)/b_scratch/"
...
defect = cv2.imread("/home/nvidia/Desktop/opencvTest/half/b_scratch1.jpg")
img = cv2.imread("/home/nvidia/Desktop/findfinger/NG/ng_defect_cutby6/01_cut4.jpg")
# if img == None:
#     continue
h,w,_ = img.shape
action_img  = img.copy()
...
split_oriimg= action_img
split_grayimg= cut_img
# Contours
...
for val in range(0,6):
    ...
    final_img[cy- h//2: cy+hf_h, cx- w//2-5: cx+ hf_w-5] = defect
...
# outputImg_name=(CONV_OUT_PATH+ file_name+ "_false.jpg")
# cv2.imwrite(outputImg_name, bla_background)
